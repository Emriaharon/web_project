...
# WARNING: Ensure imports from `web_project` comes after this line
from web_project import app, settings, db  # noqa
from web_project.cli import create_user, cli  # noqa
