...
- 🎯 Entry points to execute your program using `python -m <web_project>` or `$ web_project` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/Emriaharon/web_project/branch/main/graph/badge.svg?token=web_project_token_here)](https://codecov.io/gh/Emriaharon/web_project)
[![CI](https://github.com/Emriaharon/web_project/actions/workflows/main.yml/badge.svg)](https://github.com/Emriaharon/web_project/actions/workflows/main.yml)

Awesome web_project created by Emriaharon

## Install

from source
```bash
git clone https://github.com/Emriaharon/web_project web_project
cd web_project
make install
```
...
```bash
pip install web_project
```

## Executing

```bash
$ web_project run --port 8080
```

or

```bash
python -m web_project run --port 8080
```

or

```bash
$ uvicorn web_project:app
```
...
```bash
❯ web_project --help
Usage: web_project [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ web_project create-user --help
Usage: web_project create-user [OPTIONS] USERNAME PASSWORD
...
```bash
web_project create-user admin admin --superuser
```
...
Run with `web_project run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `web_project create-user`.
...
-----------------------------------------------------
web_project/__init__.py              4      0   100%
web_project/app.py                  16      1    94%
web_project/cli.py                  21      0   100%
web_project/config.py                5      0   100%
web_project/db.py                   10      0   100%
web_project/models/__init__.py       0      0   100%
web_project/models/content.py       47      1    98%
web_project/routes/__init__.py      11      0   100%
web_project/routes/content.py       52     25    52%
web_project/routes/security.py      15      1    93%
web_project/routes/user.py          52     26    50%
web_project/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in web_project/default.toml.
